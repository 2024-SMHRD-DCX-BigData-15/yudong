    ...
    <section id="wrapper">
        <div class="content">
            ...
            <div class="tabs">
                ...
                <button class="tablinks" data-country="Meeting" onclick="location.href='myParties'"><p data-title="Meeting">나의모임</p></button>
                <button class="tablinks active" data-country="Board"><p data-title="Board">피드</p></button>
        ...
        <div class="details">
            ...
            <div id="Board" class="tabcontent">
                <div class="feed-header">
                    <div class="user-info">
                        <img src="./images/Power.png" alt="User photo" class="user-photo">
                        <span class="user-name">지드래곤</span>
                    </div>
                    <span class="feed-date">2025-01-11</span>
                </div>
                <div class="feed-content">
                    <img src="./images/Power.png" alt="Post image" class="feed-image">
                ...
                <div class="feed-header">
                    <div class="user-info">
                        <img src="./images/Mugic.png" alt="User photo" class="user-photo">
                        <span class="user-name">흑염룡</span>
                    </div>
                    <span class="feed-date">2025-01-07</span>
                </div>
                <div class="feed-content">
                    <img src="./images/Mugic.png" alt="Post image" class="feed-image">
                    <p>난 지금 미쳐가고 있다<br>
                    이 헤드폰에 내 모든 몸과<br>
                    영혼을 맞겼다<br><br>
...
window.onload = function() {
    openTabs({ currentTarget: document.querySelector("[data-country='Board']") });
};
